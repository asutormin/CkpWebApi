...
namespace CkpWebApi.Infrastructure
{
    ...
    public static class Transliteration
    {
        ...
        public static string Front(this string text)
        {
            return Front(text, TransliterationType.ISO);
        }

        public static string Front(this string text, TransliterationType type)
        {
            string output = text;
            ...
            {
                output = output.Replace(key, tdict[key]);
            }
            return output;
        }

        public static string Back(this string text)
        {
